    ...
    <main className="mx-auto max-w-3xl px-6 py-12 text-gray-800">
      ...
      <div className="prose prose-sm mt-8 max-w-none space-y-6 leading-relaxed">
        ...
        <section>
          ...
          <p>
            O AiConfirma fornece um assistente de atendimento por WhatsApp com IA para agendamentos e
        ...
        <section>
          ...
          <p>
            ...
            condições). O AiConfirma não se responsabiliza por decisões tomadas com base exclusivamente nas
        ...
        <section>
          ...
          <p>
            Na máxima extensão permitida em lei, o AiConfirma não responde por danos indiretos, lucros cessantes
